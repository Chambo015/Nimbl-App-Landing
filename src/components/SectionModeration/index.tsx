  ...
  return (
    <section className='pt-36'>
      <div className="container relative">
        ...
        <img src={radarIcon} alt="radarIcon" className='w-[112px] h-[112px] mx-auto -mt-[56px] z-10 relative' />
        <h2 className='bg-gradient-to-b from-white to-white/50 text-transparent bg-clip-text text-center mt-7 text-5xl font-rfdewi font-black uppercase'>Redefining Moderation with Transparent AI</h2>
