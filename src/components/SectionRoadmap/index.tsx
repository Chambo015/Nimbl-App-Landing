  ...
  return (
    <section className="pt-[200px] max-sm:pt-[100px]">
      ...
      <div className="container 2xl:max-w-[1600px] relative ">
        <h2 className="bg-gradient-to-b from-white to-white/50 text-transparent hidden max-sm:block bg-clip-text font-rfdewi font-black uppercase text-2xl text-center">
          ROADMAP
        </h2>
