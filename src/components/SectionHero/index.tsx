...
export const SectionHero = () => {
 /*  const time = new Date();
  ...
  const refSlider = useRef<HTMLElement | null>(null)
  const refLight = useRef<HTMLElement | null>(null)
  ...
  return (
    <section className='mt-20 max-sm:mt-[50px] relative'>
      <img ref={refLight} src={lightImg} alt="lightImg" loading="lazy" className='absolute top-0 left-1/2 -translate-x-1/2 z-40 select-none pointer-events-none' />
      ...
      <div ref={refSlider}><SliderAppMobile /></div>
